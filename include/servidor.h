...
class Servidor{
    ...
    int get_vec_canais_texto_size(); //{return vec_canais_texto.size();}
    ...
    int get_vec_canais_voz_size(); //{return vec_canais_voz.size();}
    ...
    int get_vec_usuarios_ids_size(){return vec_usuarios_ids.size();}
